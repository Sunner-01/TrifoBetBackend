...
export class SeleccionDto {
  ...
  @IsString()
  @MaxLength(200, {
    message: 'El nombre del evento no puede superar los 200 caracteres',
  })
  eventoNombre?: string;
...
export class CrearApuestaDto {
  ...
  @IsEnum(TipoApuesta, {
    message: 'El tipo debe ser "simple", "combinada" o "sistema"',
  })
  tipo: TipoApuesta;
  ...
  @ArrayMaxSize(20, {
    message: 'El cupón no puede tener más de 20 selecciones',
  })
